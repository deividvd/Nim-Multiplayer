const HowToPlay = {
  ...
  <article>
    ...
    <p>
      ...
      <br/>
      Prima di cominciare una partita è possibile scegliere tra 2 modalità di vittoria: <b>Standard</b> o <b>Marienbad</b>.
      <br/>
    ...
    <p>
      <span class="topic"> Turni </span>
      <br/>
      Ci sono 2 modalità per gestire l'ordine dei turni di gioco: <b>Rotazione</b> e <b>Chaos</b>.
      <br/>
      ...
      <br/>
      <b>Chaos</b>: prima e durante lo svolgimento della partita, il gioco stabilisce 
      un ordine casuale con cui alternare i turni dei giocatori,
    ...
    <p>
      ...
      <br/>
      <b>Standard</b>: quando un giocatore rimuove l'ultimo bastoncino, vince e la partita finisce.
      <br/>
      <b>Marienbad</b>: quando un giocatore rimuove l'ultimo bastoncino, viene eliminato dalla partita,
    ...
    <p>
      ...
      previste dalla <b>vittoria Marienbad</b>, per cui, i bastoncini vengono ripristinati tutti,
